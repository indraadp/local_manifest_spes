...
# Device
git clone --depth=1 -b 13 https://github.com/parixshit-ci/device_xiaomi_spes.git device/xiaomi/spes
git clone --depth=1 -b 13 https://github.com/parixshit-ci/device_xiaomi_sm6225-common.git device/xiaomi/sm6225-common
...
# Device (QCOM)
git clone --depth=1 -b 13 https://github.com/parixshit-ci/device_qcom_common.git device/qcom/common
...
git clone --depth=1 -b 13 https://github.com/parixshit-ci/device_qcom_common-sepolicy.git device/qcom/common-sepolicy
